...
# Each client has a unique alias email for correct Violet domain matching.
# ---------------------------------------------------------------------------
CLIENTS = [
    {
        "name": "Hargreaves & Partners Ltd",
        "status": "Healthy",
        "email": "hargreaves.partners.test@quantistai.com",
        "assigned_to": "sarah.chen",
    },
    {
        "name": "Meridian Consulting Solutions",
        "status": "Healthy",
        "email": "meridian.consulting.test@quantistai.com",
        "assigned_to": "james.walker",
    },
    {
        "name": "Wentworth Solutions Ltd",
        "status": "Critical",
        "email": "wentworth.solutions.test@quantistai.com",
        "assigned_to": "james.walker",
    },
    {
        "name": "Thornbury Creative Agency",
        "status": "At Risk",
        "email": "thornbury.creative.test@quantistai.com",
        "assigned_to": "sarah.chen",
    },
    {
        "name": "Pinnacle Property Management",
        "status": "At Risk",
        "email": "pinnacle.property.test@quantistai.com",
        "assigned_to": "james.walker",
    },
    {
        "name": "Blackwood Digital Ltd",
        "status": "Dormant",
        "email": "blackwood.digital.test@quantistai.com",
        "assigned_to": "sarah.chen",
    },
]

# ---------------------------------------------------------------------------
# Outbound emails: internal Outlook → client alias
# from_username: M365 username prefix (no @domain)
# to_email: destination client alias address
# ---------------------------------------------------------------------------
OUTBOUND_EMAILS = [
    # --- Sarah Chen: Hargreaves & Partners (healthy, frequent contact) ---
    {
        "from_username": "sarah.chen",
        "to_email": "hargreaves.partners.test@quantistai.com",
    ...
    {
        "from_username": "sarah.chen",
        "to_email": "thornbury.creative.test@quantistai.com",
    ...
    {
        "from_username": "sarah.chen",
        "to_email": "blackwood.digital.test@quantistai.com",
    ...
    },
    {
        ...
        # NOTE: This is the LAST email for Blackwood. No further contact = 2-month gap.
    },
    # --- James Walker: Meridian Consulting (healthy) ---
    {
        "from_username": "james.walker",
        "to_email": "meridian.consulting.test@quantistai.com",
    ...
    {
        "from_username": "james.walker",
        "to_email": "wentworth.solutions.test@quantistai.com",
    ...
    {
        "from_username": "james.walker",
        "to_email": "pinnacle.property.test@quantistai.com",
...
# ---------------------------------------------------------------------------
# Inbound emails: client alias → Outlook
# Injected directly into the M365 inbox via Graph API.
# from_email: client alias (appears as sender)
# to_username: M365 username prefix
# ---------------------------------------------------------------------------
INBOUND_EMAILS = [
    # Hargreaves → Sarah
    {
        "from_email": "hargreaves.partners.test@quantistai.com",
    ...
    # Meridian → James
    {
        "from_email": "meridian.consulting.test@quantistai.com",
    ...
    {
        "from_email": "wentworth.solutions.test@quantistai.com",
        "to_username": "james.walker",
    ...
    # Thornbury → Sarah
    {
        "from_email": "thornbury.creative.test@quantistai.com",
        "to_username": "sarah.chen",
    ...
    # Blackwood → Sarah (ONLY ONE — 2-month gap)
    {
        "from_email": "blackwood.digital.test@quantistai.com",
        "to_username": "sarah.chen",
...
CALENDAR_EVENTS = [
    # --- Sarah Chen ---
    {"username": "sarah.chen", "subject": "Hargreaves & Partners Ltd — Design review",
     "body": "Monthly design review with Hargreaves & Partners.", **_future(days=7, hour=10)},
    {"username": "sarah.chen", "subject": "Thornbury Creative Agency — Brand guidelines sign-off",
     "body": "Final brand guidelines sign-off meeting.", **_future(days=9, hour=14)},
    {"username": "sarah.chen", "subject": "Thornbury Creative Agency — Scope change discussion",
     "body": "Discussion re: social media templates scope addition.", **_future(days=10, hour=11)},
    {"username": "sarah.chen", "subject": "Team standup",
     "body": "Daily team standup.", **_future(days=1, hour=9, minute=15)},
    {"username": "sarah.chen", "subject": "Quarterly portfolio review — all clients",
     "body": "Quarterly review of all active client portfolios.", **_future(days=21, hour=14)},
    # --- James Walker ---
    {"username": "james.walker", "subject": "Meridian Consulting Solutions — Audit progress call",
     "body": "Q3 audit progress review call with Meridian.", **_future(days=8, hour=11)},
    {"username": "james.walker", "subject": "Wentworth Solutions Ltd — Project Nexus escalation",
     "body": "Escalation call re: Project Nexus delays. NOTE: No follow-up email sent after this.",
     **_past(days=7, hour=15)},
    {"username": "james.walker", "subject": "Pinnacle Property Management — Portfolio review catch-up",
     "body": "Catch-up on portfolio review progress. NOTE: No follow-up email sent after this.",
     **_past(days=14, hour=10)},
    {"username": "james.walker", "subject": "Team standup",
     "body": "Daily team standup.", **_future(days=1, hour=9, minute=15)},
    {"username": "james.walker", "subject": "New business — pipeline review",
     "body": "Weekly pipeline review.", **_future(days=6, hour=16)},
]

# ---------------------------------------------------------------------------
# Xero contact email map — one unique alias per client
# ---------------------------------------------------------------------------
XERO_CONTACT_EMAIL_MAP = {
    "Hargreaves & Partners Ltd":       "hargreaves.partners.test@quantistai.com",
    "Meridian Consulting Solutions":   "meridian.consulting.test@quantistai.com",
    "Wentworth Solutions Ltd":         "wentworth.solutions.test@quantistai.com",
    "Pinnacle Property Management":    "pinnacle.property.test@quantistai.com",
    "Thornbury Creative Agency":       "thornbury.creative.test@quantistai.com",
    "Blackwood Digital Ltd":           "blackwood.digital.test@quantistai.com",
}
